...
<html>
  <head>
    <title>Minimal 1.0 - Form Elements</title>
    ...
    <link rel="stylesheet" href="<%=basePath%>/assets/js/vendor/colorpicker/css/bootstrap-colorpicker.css">
    <link rel="stylesheet" href="<%=basePath%>/assets/js/vendor/colorpalette/bootstrap-colorpalette.css">
  ...
  <body class="bg-1">
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="main">
                        ...
                        6 <select class="chosen-select chosen-transparent form-control" >
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
    ...
    <script src="<%=basePath%>/assets/js/vendor/colorpicker/bootstrap-colorpicker.min.js"></script>

    <script src="<%=basePath%>/assets/js/vendor/colorpalette/bootstrap-colorpalette.js"></script>
