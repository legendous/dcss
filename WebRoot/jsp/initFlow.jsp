...
<html>
  ...
  <body class="bg-7">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <div class="navbar-collapse">
            ...
            <div class="search" id="main-search">
              <i class="fa fa-search"></i> <input type="text" placeholder="Search..." onclick="initFlowByFile()">
            </div>
            <!-- Search end -->
	...
	//获得流程数据;	
	function initFlowByFile() {
		$.ajax( { //一个Ajax过程 
					type : "post", //以post方式与后台沟通 
					url : "<%=basePath%>initFlowByFile.do", //与此处理该请求的servlet沟通 
					dataType : 'json',//从servlet返回的值以 JSON方式 解释 
					data : 'filename='+111, //发给servlet的数据 
	...
	<form action="action.do" method="POST">
		<!-- 隐藏参数 -->
	    <input type="hidden" id="flow_id" name="flow_id" value="111"/>
