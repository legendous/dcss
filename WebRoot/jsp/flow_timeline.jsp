      ...
      <div class="row">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <div class="navbar-header col-md-2">
            ...
            <div class="sidebar-collapse"> <!-- 左边条控制器 -->
              <a href="#">
	...
	function addLi(parentId, objVal){
		...
		var li = "<li class='color transparent-black'>"+
                    ...
                    "<div class='el-container'>"+
                      "<div class='content' id='div_"+objVal.TASK_ID+"'>"+
                        "<span class='time'><i class='fa fa-clock-o'></i>"+objVal.TASK_BEGIN_TIME_PLAN+"</span>"+
                        "<h3><strong>"+objVal.TASK_ID+"&nbsp"+objVal.TASK_NAME+"</strong></h3>"+
                       "</div>"+
                    "</div>"+
                  "</li>";
		...
		if(objVal.task != undefined){
			...
			$.each(objValChild, function(index1,objVal1) { //遍历对象数组，index是数组的索引号，objVal是遍历的一个对象。  
				...
				//将子步骤加入p中
				var p = objVal1.TASK_ID+" "+objVal1.TASK_BEGIN_TIME_PLAN+" "+objVal1.TASK_CONTENT;
				...
				p = "<p>"+p+"</p>";
				$(p).appendTo($("#div_"+objVal.TASK_ID));
			});
		}else{
			var p = "<p>&nbsp;</p>"
			$(p).appendTo($("#div_"+objVal.TASK_ID));
