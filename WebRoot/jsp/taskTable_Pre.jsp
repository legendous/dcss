...
<html>
  ...
  <body class="bg-7">
	...
	function addTr(parentId, objVal){
		...
		if(objVal.TASK_STAT=="0"){
			...
			stat = '<div class="progress">'+
                      '<div class="progress-bar progress-bar-cyan" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 100%">'+
                        '待执行'+
                      '</div></div>';
	...
	<form action="action.do" method="POST">
	    ...
	    <input type="hidden" id="actionName" name="actionName" value="taskTable_Pre"/>
