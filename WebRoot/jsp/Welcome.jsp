...
<html>
  ...
  <table border=1 height="100%">
  	<tr>
  	  <td colspan="2">
		<div class="title">
		  <h1><img src="<%=basePath%>/assets/images/hkb-logo.jpg" alt class="logo">指挥调度系统 DCSS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 安全&nbsp;&nbsp;&nbsp;&nbsp;有序&nbsp;&nbsp;&nbsp;&nbsp;高效&nbsp;&nbsp;&nbsp;&nbsp;细心</h1>
		</div>
...
<form id="form" name="form" action="action.do" method="POST">
    ...
    $(document).ready(function() {//这个就是jQueryready，当所有需要加载的内容加载完后，就会执行，比onload更靠前
    	...
    	refreshWelcome('flowCards','progress','charts');
	});	
