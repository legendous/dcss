  ...
  <body class="bg-7">
	...
	function addTr(parentId, objVal){
		...
		if(objVal.TASK_STAT=="0"){
			...
			stat = "<span class='label label-warning' style='display:inline-block;width:50px;'>异&nbsp;&nbsp;&nbsp;&nbsp;常</span>";
		}else if(objVal.TASK_STAT=="3"){
			stat = "<span class='label label-danger' style='display:inline-block;width:50px;'>失&nbsp;&nbsp;&nbsp;&nbsp;败</span>";
		}else if(objVal.TASK_STAT=="4"){
			stat = "<span class='label label-success' style='display:inline-block;width:50px;'>已完成</span>";
		}else{
			stat = "<span class='label label-default' style='display:inline-block;width:50px;'>未&nbsp;&nbsp;&nbsp;&nbsp;知</span>";
		}
		...
		var table = "<tr id='tr_"+objVal.TASK_ID+"' onclick='showTaskInfoTr(this)'>"+
					...
					"<td>"+"计划："+objVal.TASK_BEGIN_TIME_PLAN+" 至 "+objVal.TASK_END_TIME_PLAN+"</td>"+
					"</tr>";
		...
		table = "<tr id='tr_info_"+objVal.TASK_ID+"' style='display:none;'>"+
				...
				"<td colspan='2'>"+
                    ...
                    "</select>"+
				"</td>"+
				"<td onclick='inputTime(this)'>"+"实际："+task_begin_time_real+" 至 "+task_end_time_real+"</td>"+
				"</tr>";
		$(table).appendTo($("#"+parentId));	
	...
	<!-- 隐藏参数 -->
    <input type="hidden" id="FLOW_ID" value="1" />
    <input type="hidden" id="TASK_ID" value="" />
    <input type="hidden" id="TASK_STAT" value="" />
