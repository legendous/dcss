      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            <h2><i class="fa fa-puzzle-piece" style="line-height: 48px;padding-left: 5px;"></i> 2015年年终结转 <span> // The Flow Table </span></h2>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <section class="tile transparent">
                  ...
                  <div class="tile-header transparent">
                    <h1><strong>1 关联系统联调测试</strong> 2015.12.30</h1>
                    <div class="controls">
                          ...
                          <div class="front"> 
                            ...
                            <div class="media">
                              ...
                              <div class="media-body">
                                <div class="title">1-1 信息科技部</div>
                                <h3 class="media-heading animate-number" data-value="测试系统环境检查" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                        ...
                        <div class="card card-greensea hover">
                          <div class="front">        
                            ...
                            <div class="media">
                              ...
                              <div class="media-body">
                                <div class="title">1-2 会计结算部</div>
                                <h3 class="media-heading animate-number" data-value="个贷、核心系统测试数据检查" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                      ...
                      <div class="card-container col-lg-3 col-sm-6 col-sm-12">
                        <div class="card card-greensea hover">
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                <div class="title">1-3 金融市场部</div>
                                <h3 class="media-heading animate-number" data-value="资金系统测试数据检查" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                ...
                                <h3 class="media-heading animate-number" data-value="年终结转关联测试" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
              ...
              <div class="col-md-12">
                ...
                <section class="tile transparent">
                  ...
                  <!-- tile header -->
                  <div class="tile-header transparent">
                    <h1><strong>2 结转前状态检查</strong> 2015.12.31</h1>
                    <div class="controls">
                      <a href="#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="#" class="remove"><i class="fa fa-times"></i></a>
                    </div>
                      ...
                      <div class="card-container col-lg-3 col-sm-6 col-sm-12">
                        <div class="card card-redbrown hover">
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                <div class="title">2-1 会计结算部</div>
                                <h3 class="media-heading animate-number" data-value="检查核心30日日终、计提" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card-container col-lg-3 col-sm-6 col-sm-12">
                        <div class="card card-blue hover">
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                <div class="title">2-2 金融市场部 营运部 信息科技部</div>
                                <h3 class="media-heading animate-number" data-value="理财核对、上账" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card-container col-lg-3 col-sm-6 col-sm-12">
                        <div class="card card-blue hover">
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                <div class="title">2-3 会计结算部</div>
                                <h3 class="media-heading animate-number" data-value="网点停止对外营业" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card-container col-lg-3 col-sm-6 col-xs-12">
                        <div class="card card-blue hover">
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                <div class="title">2-4 计划财务部</div>
                                <h3 class="media-heading animate-number" data-value="贷款损失准备计提比例维护" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card-container col-lg-3 col-sm-6 col-xs-12">
                        <div class="card card-blue hover">
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                <div class="title">2-5 会计结算部</div>
                                <h3 class="media-heading animate-number" data-value="网点签退（除营运部）" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card-container col-lg-3 col-sm-6 col-xs-12">
                        <div class="card card-blue hover">
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                <div class="title">2-6 信息科技部</div>
                                <h3 class="media-heading animate-number" data-value="核心系统年终" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card-container col-lg-3 col-sm-6 col-xs-12">
                        <div class="card card-blue hover">
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                <div class="title">2-7 计划财务部</div>
                                <h3 class="media-heading animate-number" data-value="财务系统小总账月结" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
              ...
              <div class="col-md-12">
                ...
                <section class="tile transparent">
                  ...
                  <!-- tile header -->
                  <div class="tile-header transparent">
                    <h1><strong>3 核心年终结转</strong> 2016.1.1</h1>
                    <div class="controls">
                      <a href="#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="#" class="remove"><i class="fa fa-times"></i></a>
                    </div>
                      ...
                      <div class="card-container col-lg-3 col-sm-6 col-sm-12">
                        <div class="card card-slategray hover">
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                <div class="title">3-1 信息科技部 营运部</div>
                                <h3 class="media-heading animate-number" data-value="渠道和业务功能开启" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card-container col-lg-3 col-sm-6 col-sm-12">
                        <div class="card card-slategray hover">
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                <div class="title">3-2 计划财务部 信息科技部</div>
                                <h3 class="media-heading animate-number" data-value="大总账12月月结" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card-container col-lg-3 col-sm-6 col-sm-12">
                        <div class="card card-slategray hover">
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                <div class="title">3-3 计划财务部</div>
                                <h3 class="media-heading animate-number" data-value="损益确认及财务系统中账务调整" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card-container col-lg-3 col-sm-6 col-xs-12">
                        <div class="card card-slategray hover">
                          ...
                          <div class="front">   
                            <div class="media">
                              <div class="media-body">
                                <div class="title">3-4 计划财务部</div>
                                <h3 class="media-heading animate-number" data-value="小总账年结" data-animation-duration="1500">0</h2>
                              </div>
                            </div>
                          </div>
