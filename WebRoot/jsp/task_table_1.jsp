...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<%=basePath%>/assets/js/vendor/summernote/css/summernote.css">
    <link rel="stylesheet" href="<%=basePath%>/assets/js/vendor/summernote/css/summernote-bs3.css">
  ...
  <body class="bg-7">
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            <h2><i class="fa fa-puzzle-piece" style="line-height: 48px;padding-left: 5px;"></i> 任务列表 <span>// Tasks </span></h2>
    ...
    <script src="<%=basePath%>/assets/js/vendor/summernote/summernote.min.js"></script>
	...
	function getFlow() {
		...
		$.ajax( { //一个Ajax过程 
					...
					data : 'flow_id=1&time_mode=time', //发给servlet的数据 
	...
	function addTr(parentId, objVal){
		...
		var table = "<tr id='tr_"+objVal.TASK_ID+"' >"+
					"<td width='10%'>"+objVal.TASK_ID+"</td>"+
					"<td width='40%'>"+objVal.TASK_CONTENT+"</td>"+
					"<td width='10%'>"+stat+"</td>"+ 	//为初始化状态下拉框做准备
					
					"<td width='10%' onclick=''>"+		//状态选择，没办法，动态加载这个select效果很差，只能写这了
					...
					"<td width='10%'><small>"+objVal.HEADER_NAME+"</small></td>"+
					"<td width='20%'><small>"+objVal.TASK_BEGIN_TIME_PLAN+" 至 "+objVal.TASK_END_TIME_PLAN+"</small></td>"+
					"</tr>";
    ...
    $(function(){
      ...
      //chosen select input 通过chosen插件来美化select元素   此行为去掉其搜索区域
