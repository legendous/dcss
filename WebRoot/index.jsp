...
<html>
  ...
  <table height="80%">
  	<tr>
  	  <td colspan="10">
		<div class="title">
		  <h1><img src="<%=basePath%>/assets/images/hkb-logo.jpg" alt class="logo">灾备指挥调度系统 DCSS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 安全&nbsp;&nbsp;&nbsp;&nbsp;有序&nbsp;&nbsp;&nbsp;&nbsp;高效&nbsp;&nbsp;&nbsp;&nbsp;细心</h1>
		</div>
  	...
  	<tr>
  	  <td width="1920px" height="80%" align="center">
  	  	<img src="<%=basePath%>/MyAssets/images/organization.png">
  	  </td>
  	</tr>
  </table>
